...
const BookAppoinment = () => {
    ...
    const [breedFormHide, setBreedFormHide] = useState(false);
    const [dateAndTimeForm, setDateAndTimeForm] = useState(true);
    ...
    const breedFormOnsubmit = (e) => {
        e.preventDefault();
        if (selectBreed == "" || breed == "" ||
            breed == undefined || petName == "" ||
            age == "") {
            setError(true);
        } else {
    ...
    const dateAndTimeOnsubmit = (e) => {
        e.preventDefault();
        if (selectedDate == "" || selectedDate == undefined || selectTime == "" || selectTime == undefined) {
            setError(true);
        } else {
                    ...
                    <div className="container miran-register mt-3">
                        <div className="row">
                            <div className="col-lg-6 col-md-12" style={{ margin: "0 auto" }}>
                                ...
                                <div className="my-profile-box" style={{ marginBottom: "185px" }}>
                                    {/* <h3>Create Pet</h3> */}
                                    {breedFormHide && (<form onSubmit={breedFormOnsubmit}>
                                        <div className="row">
                                                ...
                                                <>
                                                    <div className="col-xl-12 col-lg-12 col-md-12 ">
                                                        <div className="form-group">
                                                            ...
                                                            {error && breed.length == "" ? (
                                                                <span className="text-danger">Please Select Breed</span>
                                                            ) : (
                                                                <></>
                                                            )}
                                                        </div>
                                    ...
                                    {dateAndTimeForm && (
                                        <form onSubmit={dateAndTimeOnsubmit}>
                                            <form>                                            <div className="row">
                                                ...
                                                {dateTimeShow && (<div className="col-xl-12 col-lg-12 col-md-12">
                                                    <div className="form-group">
                                                        <label>Select time</label>
                                                        <div className="selectTime">
                                                            <p onClick={() => selectOnclickTime("09:00 - 10:00")}>09:00 - 10:00</p>
                                                            <p onClick={() => selectOnclickTime("10:30 - 12:00")}>10:30 - 12:00</p>
                                                            <p onClick={() => selectOnclickTime("13:00 - 14:00")}>13:00 - 14:00</p>
                                                            <p onClick={() => selectOnclickTime("15:00 - 16:00")}>15:00 - 16:00</p>
                                                            <p onClick={() => selectOnclickTime("17:00 - 18:00")}>17:00 - 18:00</p>
                                                        </div>
                                                    </div>
                                                </div>)}
                                                ...
                                                <div className="col-lg-12 col-md-12">
                                                    <div className="form-group">
                                                        <button onClick={dateAndTimeOnsubmit} type="submit">Next</button>
                                                    </div>
                                                </div>
                                            </div>
                                            </form>
                                    ...
                                    {customerFormHide && (<form onSubmit={customerFormOnsubmit}>
                                        <div className="row">
                                            <div className="col-xl-12 col-lg-12 col-md-12">
                                                <div className="form-group">
